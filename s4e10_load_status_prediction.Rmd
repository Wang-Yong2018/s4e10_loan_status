...
write_csv(submission, "submission_rstudio.csv")
```

# submit to kaggle
```{r}
# submit latest submission.csv
system('kaggle competitions submit -c playground-series-s4e10 -f submission.csv -m "0.96 xgb kaggle with last_fit in rstudio"')
Sys.sleep(5)
# get latest score 
